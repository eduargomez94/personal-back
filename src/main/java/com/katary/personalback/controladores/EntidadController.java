...
import com.katary.personalback.esquema.io.EntidadIn;
import com.katary.personalback.esquema.secuencias.EntidadSecuencia;
...
public class EntidadController {
    ...
    @Autowired
    public EntidadController(FrameworkService fw, EntidadSecuencia entidadSecuencia) {
        this.fw = fw;
