...
import com.katary.personalback.esquema.io.PeriodoIn;
import com.katary.personalback.esquema.secuencias.PeriodoSecuencia;
...
public class PeriodoController {
    ...
    @Autowired
    public PeriodoController(FrameworkService fw, PeriodoSecuencia periodoSecuencia) {
        this.fw = fw;
