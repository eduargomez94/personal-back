...
import com.katary.personalback.esquema.bd.empleado.EmpleadoDB;
...
public class EmpleadoSecuencia {
    ...
    public HashMap<String, Object> obtenerEmpleadoMisDatos(int id_usuario) throws SQLException {
        HashMap<String, Object> data = empleadoDB.obtenerEmpleadoIdUsuario(id_usuario);
        if (data.get("url_fotografia") != null && data.containsKey("url_fotografia")) {
            String base64Foto = this.archivoSecuencia.descargarArchivo(data.get("url_fotografia").toString());
            data.put("file_foto", base64Foto);
        }
