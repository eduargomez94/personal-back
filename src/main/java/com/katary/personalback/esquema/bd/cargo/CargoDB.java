package com.katary.personalback.esquema.bd.cargo;
...
import static com.katary.personalback.esquema.bd.cargo.Consultas.*;
...
public class CargoDB {
    ...
    public int crearCargo(int id_cargo, String descripcion_cargo, int id_categoria) throws SQLException {
        Object[] parametros = new Object[]{descripcion_cargo, id_categoria};
        return dbCoreService.ejecutarQuery(SP_CARGO_INSERT, parametros);
    }

    public int actualizarCargo(int id_cargo, String descripcion_cargo, int id_categoria) throws SQLException {
