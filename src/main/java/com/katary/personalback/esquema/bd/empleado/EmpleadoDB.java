...
import static com.katary.personalback.esquema.bd.empleado.Consultas.*;
...
public class EmpleadoDB {
    ...
    public HashMap<String, Object> obtenerEmpleadoIdUsuario(int id_usuario) throws SQLException {
        Object[] parametros = new Object[]{id_usuario};
        return dbCoreService.obtenerElemento(SP_EMPLEADO_SELECT_X_ID_USUARIO, parametros);
    }
